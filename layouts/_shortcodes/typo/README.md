...
Hugo shortcodes for narrative typography. Terminology from journalism, print design, and screenwriting. Each shortcode maps to a CSS class in `assets/css/typography.css`.
