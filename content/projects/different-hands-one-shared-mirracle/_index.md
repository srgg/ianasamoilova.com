...
{{< typo/runaround side="right" flow="column" image="child-handprints.png" alt="Student creating handprint art" >}}
We gently dipped students' hands into paint. One by one, they placed their handprints on paper. SPED role was simple:
cut, arrange, support when needed, and assemble the pieces into a single artwork.
...
{{< typo/runaround side="left" flow="wrap" image="blue-paint-hand.png" alt="Hand dipped in blue paint" >}}
{{< typo/kicker >}}Hands tell stories before words do:{{< /typo/kicker >}}
...
{{< typo/aside >}}**That is how I understand special education:** not as a system that tries to make everyone the same, but as a space where differences are recognized—and allowed to belong.{{< /typo/aside >}}

{{< typo/nutgraf >}}I'm sharing this project as part of my professional reflection as a future SPED teacher. Not because it was extraordinary, but because it was ordinary—and still so often withheld.{{< /typo/nutgraf >}}
